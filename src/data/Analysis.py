...
class ParkerAnalysis:
    ...
    """ Cleaning VARIABLES """
    CATEGORICAL_VARIABLES = ['RACE', 'STFIPS', 'MARSTAT', 'LIVARAG', 'PRIMINC', 'REGION', 'DIVISION', 'SERVSETD', 'DETCRIM', 'SUB1', 'ROUTE1', 'SUB2', 'ROUTE2', 'SUB3', 'ROUTE3', 'IDU', 'ALCDRUG', 'DSMCRIT', 'HLTHINS', 'PRIMPAY']
...
class JosiahAnalysis:
    ...
    DECISION_VARIABLES = ['REASON', 'LOS']
    HARD_NOT_NAN_VARIABLES = ['DAYWAIT', 'METHUSE', 'SERVSETD', 'ARRESTS', 'PRIMINC', 'VET', 'MARSTAT', 'PSOURCE',
                              'DETCRIM', 'NOPRIOR', 'SUB1', 'ROUTE1', 'FREQ1', 'FRSTUSE1',
                              'HLTHINS'] + DECISION_VARIABLES
